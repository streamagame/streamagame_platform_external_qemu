...
static SDL_Surface *openSDLWindow(int width, int height, int density)
{
  ...
  snprintf(title, 512 * sizeof(*title), "Stream-A-Game Renderer (%d x %d @ %d dpi)", width, height, density);
...
void streamagameRenderer(int width, int height)
{
